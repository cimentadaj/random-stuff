...
yrsedu[2] <- lapply(yrsedu[2], round, 2) ## Let's make the numbers easier to understand
...
## Replace all Province names of data frame 4 with the names of the first one(which are all correctly
## spelled)
