...
## How do you interpret this? For instance,
## the variance in the estimated coefficient of Education is 2.774943 times what it might have been if Education were not
## correlated with the other regressors. Since Education and score on an Examination are likely to be correlated, we might
## guess that most of the variance inflation for Education is due to including Examination.
